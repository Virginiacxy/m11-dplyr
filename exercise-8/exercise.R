...
most.publication <- filter(pulitzer, max(Pulitzer.Prize.Winners.and.Finalists..2004.2014) == 
                      Pulitzer.Prize.Winners.and.Finalists..2004.2014) %>% 
                      select(Newspaper)
...
publication.5.pulizters.most.decrease <- filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5) %>% 
